...
//////////initUserAccess Validation Starts
    ...
    //////////AddActivity Validation Starts
        ...
        //////////wqcertificatemaster Validation Starts
        initWQCertificateMaster: function () {
            $('.wqcertificatemaster-form').validate({
                errorElement: 'span', //default input error message container
                errorClass: 'help-block', // default input error message class
                focusInvalid: false, // do not focus the last invalid input
                rules: {
                ...
                messages: {
                    ...
                    bill_lading_qty: {
                        required: "Bill Lading Quantity is required."
                    },
                    bill_lading_namedt: {
                        required: "Bill Lading Number & Date is required."
                    },                                   
                    remember: {
                        required: "Remember is required."
                    }
                ...
                invalidHandler: function (event, validator) { //display error alert on form submit   
                    $('.alert-danger', $('.wqcertificatemaster-form')).show();
                },
        ...
        ////////// wqcertificatemaster Validation Ends 
        ...
        initMailDocsMaster: function () {
            $('.maildocsmaster-form').validate({
                ...
                invalidHandler: function (event, validator) { //display error alert on form submit   
                    $('.alert-danger', $('.maildocsmaster-form')).show();
                },
        ...
        ////////// maildocsmaster Validation Ends 
