														...
														<div class="form-group">
															...
															<div class="col-md-9">															
													                ...
													                foreach($rows as $cargo_group_data){ 
													                	echo '<option value='.$cargo_group_data["id"].'>'.$cargo_group_data["name"].'</option>';
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="commodity_name" id="commodity_name">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="parameter_name" id="parameter_name">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="subparameter_name" id="subparameter_name">
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																<select class="form-control" name="parameter_category" id="parameter_category">
																	...
																	<option value="Residues and Tracemetal">Residues and Tracemetal</option>
																</select>
