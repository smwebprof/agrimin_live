					...
					<div class="portlet box grey">
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="<?php echo BASE_PATH; ?>addaccountledgerfileno" class="btn blue">
								...
								<a href="<?php echo BASE_PATH; ?>Uploadledgerdatafileno" class="btn green">
						    ...
						    <tr class="odd gradeX">
								...
								<td>
									...
									<span class="label label-sm label-success">
										 ...
										 <a href="<?php echo BASE_PATH; ?>editaccountledgerfileno?id=<?php echo base64_encode($ledger_data['vendor_name']); ?>"  style="color:#fff">Edit</a>
									</span>
									<?php } ?>
								</td>
								<?php } ?>
