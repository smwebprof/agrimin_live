				...
				<div class="col-md-12">
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>View Invoices (Multiple)
							</div>
							<div class="actions">
							...
							<div class="table-toolbar">
								...
								<div class="btn-group">
									...
									<select class="form-control" id="invoice_type" name="invoice_type">
										...
										<option value ="Multiple" <?php if (@$this->data['invoice_type'] == 'Multiple') { echo 'selected'; } ?>>Multiple</option>
