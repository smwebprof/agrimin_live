				...
				<div class="col-md-12">
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>View Weight Certificates
							</div>
							<div class="actions">
								<?php /*
						    ...
						    <tr class="odd gradeX">
								...
								<?php if (@$this->data['invoice_details'][$invoice_data['file_no']] != 'Final') { ?>
									  ...
									  <span class="label label-sm label-info">
											<a href="<?php echo BASE_PATH; ?>editweightcertificate?id=<?php echo base64_encode(@$this->data['cert_data'][$invoice_data['id']]['cert_id']); ?>"  style="color:#fff">Edit</a>
										</span>
									  <?php } else { ?>	
									  <span class="label label-sm label-success">
											<a href="<?php echo BASE_PATH; ?>	addweightcertificate?id=<?php echo base64_encode($invoice_data['id']); ?>"  style="color:#fff">Add New</a>
									  </span>
									  <?php } ?>
									  <?php } ?>
							    <?php } ?>
								...
								<td>
									 <?php if (@$this->data['cert_data'][$invoice_data['id']]['status'] == 'Final') { ?>
									 <span class="label label-sm label-success">
											<a href="<?php echo BASE_PATH; ?>Downloadweightcertificate?id=<?php echo base64_encode(@$this->data['cert_data'][$invoice_data['id']]['cert_id']); ?>"  style="color:#fff" target="_blank"> Download Weight</a>
											</span>&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp; 
											<span class="label label-sm label-info">
											<a href="<?php echo BASE_PATH; ?>Downloadweightqualitycertificate?id=<?php echo base64_encode(@$this->data['cert_data'][$invoice_data['id']]['cert_id']); ?>"  style="color:#fff" target="_blank"> Download (Weight&Quality)</a>
											</span>
									 <?php } ?> 
								</td>
								<?php /*
