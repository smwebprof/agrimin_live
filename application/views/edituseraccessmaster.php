								...
								<!--<div class="btn-group">
									...
									<div class="portlet-body form">
										...
										<form action="" method="post" class="form-horizontal accessmaster-form">
											...
											?>
											<?php
											$data = $this->data['user_details'];

											foreach($data as $user_details){
											?>	
											<input type="hidden" class="form-control" placeholder="" name="user_access_id" id="user_access_id" value="<?php echo $user_details['id']; ?>">
											<div class="form-body">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="user_type" id="user_type" value="<?php echo $user_details['employee_staff']; ?> " readonly>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="user_name" id="user_name" value="<?php echo $user_details['first_name']; ?> " readonly>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control" name="edit_main_menus" id="edit_main_menus">
																<option value="">Select Main Menu</option>	
																	<?php
													                $rows = $this->data['main_menus'];
