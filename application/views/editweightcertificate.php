							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>Weight Certificate  Form
										</div>
										<div class="actions">
								<a href="<?php echo BASE_PATH; ?>Viewweightcertificate?id=<?php echo $_GET['id']; ?>" class="btn default yellow-stripe">
									<i class="fa fa-plus"></i>
									<span class="hidden-480">
										 View Weight Certificate
									</span>
								</a>
								<a href="<?php echo BASE_PATH; ?>Downloadweightcertificatedraft?id=<?php echo $_GET['id']; ?>" class="btn default yellow-stripe" target='_blank'>
									<i class="fa fa-plus"></i>
									<span class="hidden-480">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="-6m" data-date-end-date="0d">
																<input type="text" class="form-control" name="bill_lading_date" id="bill_lading_date" value="<?php echo $certificate_data['bill_lading_date']; ?>" readonly>
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<textarea class="form-control" rows="3" name="cert_para2" id="cert_para2" maxlength="1200">LOADING WAS PERFORMED ON <?php echo $certificate_data['vessel_name']; ?> AT <?php echo $certificate_data['load_port']; ?> ON <?php echo date('d-m-Y'); ?> AND WEIGHT CORRESPONDS TO THE SHORE FIGURE.</textarea>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="col-md-offset-9 col-md-9">
															...
															<a href="<?php echo BASE_PATH;?>Viewweightcertificate"><button type="button" class="btn default">Close</button></a>
