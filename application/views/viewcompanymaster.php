				...
				<div class="col-md-12">
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>View Company Master
							</div>
							<div class="actions">
								<?php if ($this->data['access_right']['add_rights'] == 1) { ?>
								<a href="<?php echo BASE_PATH; ?>addcompanymaster" class="btn blue">
						...
						<div class="portlet-body">
						    ...
						    <tr class="odd gradeX">
								...
								<td>
									 <a href="<?php echo BASE_PATH; ?>fullviewcompanymaster?id=<?php echo base64_encode($company_data['id']); ?>"><?php echo $company_data['name']; ?></a>
								</td>
								<td>
									<?php echo $company_data['address']; ?>
								</td>
								<td>
     								<?php echo $company_data['city']; ?>
								</td>
								<td>
									<?php echo $company_data['state']; ?>
								</td>
								<td class="center">
     								<?php echo $company_data['country']; ?>
								</td>
								<?php if ($this->data['access_right']['edit_rights'] == 1) { ?>
								<td>
									<span class="label label-sm label-success">
										 <a href="<?php echo BASE_PATH; ?>editcompanymaster?id=<?php echo base64_encode($company_data['id']); ?>"  style="color:#fff">Edit</a>
									</span>
								</td>
								<?php } ?>
								<?php if ($this->data['access_right']['delete_rights'] == 1) { ?>
								<td>
									<span class="label label-sm label-danger">
										 <a href="<?php echo BASE_PATH; ?>delcompanymaster?id=<?php echo base64_encode($company_data['id']); ?>"  style="color:#fff">Delete</a>
									</span>
								</td>
								<?php } ?>
							</tr>	
