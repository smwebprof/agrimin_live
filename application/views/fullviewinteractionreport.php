			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Client Interaction Form Report
					</h3>
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="#">
								Client Interaction Form Report - Full View
							</a>
						</li>
					</ul>
				...
				<div class="col-md-12">
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Client Details - Full View
							</div>
							<!--<div class="tools">
							...
							<div class="actions">
								<a href="<?php echo BASE_PATH; ?>viewinteractionreport" class="btn blue">
									<i class="fa fa-pencil"></i>View Client Interaction Reports
								</a>
								<a href="<?php echo BASE_PATH; ?>fullviewinteractionreportpdf?id=<?php echo base64_encode($this->data['id']); ?>" class="btn green" target="_blank">
