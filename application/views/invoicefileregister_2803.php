										...
										<form action="" method="post" class="form-horizontal invoicefileregister-form">
											...
											<div class="row">
														...
														<div class="portlet-body">
															<div class="table-responsive">
																...
																<tr class="active">
																	...
																	<td>
																		 <input type="text" class="form-control" placeholder="" name="cargo_group" id="cargo_group" value="<?php echo $invoice_data['cargo_group_name']; ?>" readonly>
																	</td>
																</tr>
																<tr class="active">
																	<td>
											 ...
											 ?>
											 	...
											 	<h3 class="form-section alert alert-info">Sr.No. <?php echo $i; ?> - Cargo Details for <?php echo $cargo_details['commodity_name']; ?></h3>
													...
													<div class="col-md-12">
														...
														<div class="table-scrollable">
															...
															<tr class="active">
																...
																<td>
																	 <select class="form-control input-small select2me" data-placeholder="Select..." name="invitems_unit[]" id="invitems_unit" required>
																	<!--<option value=""></option>-->
																	<?php
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="invitems_rate[]" id="invitems_rate" value="" onkeyup="cargo_amount2(this);" required>
																	 <span for="invitems_rate" class="help-block" style="color:red"></span>
																</td>
																<td>
																	 <input type="text" class="form-control input-small invitems_amt" placeholder="" name="invitems_amt[]" id="invitems_amt" value="" required readonly>
											 ...
											 <div class="row">
													<div class="col-md-12">
														...
														<!--<button id="add_row">Add row</button>-->
														<input type="hidden" name="invitems_cargo_prefix[]" id="invitems_cargo_prefix" value="<?php echo $i; ?>">
														<input type="button" value="Add Other Details" id="invoice_cargo_item_<?php echo $i; ?>" class="invoice_cargo_item" OnClick="javascript:cargo_rows(<?php echo $i; ?>);">
														<div class="table-scrollable">
															<div id="field_parameter_div">
															<table class="table table-bordered table-hover invoice_cargo_item_details" id="invoice_cargo_item_details_<?php echo $i; ?>">
															<thead>
															...
															<tr class="active">
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="invitems_quantity[]" id="invitems_quantity" value="" onkeyup="cargo_amount2(this);" required>
																	 <span for="invitems_quantity" class="help-block" style="color:red"></span>
																</td>																	
																<td>
																	<!--<input type="text" class="form-control input-small" placeholder="" name="invitems_unit[]" id="invitems_unit" value="" onkeyup="cargo_amount2(this);" required>-->
																	 <select class="form-control input-small select2me" data-placeholder="Select..." name="invitems_unit[]" id="invitems_unit" required>
																	<!--<option value=""></option>-->
																	<?php
													                $rows = $this->data['units'];
