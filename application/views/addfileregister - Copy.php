											...
											<div class="form-body">
												...
												* Marked fields are Mandotary <br/><br/>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control" id='cargo_group' name="cargo_group">
																	<option value="">Please Select</option>
																	<option value="">Dry Cargo</option>
																	<option value="">Liquid Cargo</option>
																</select>
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control" id="packing_desc" name="packing_desc">
																	<option>Bags</option>
																	<option>Bulk</option>
																</select>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control"  id="approx_unit" name="approx_unit" style="width:7em" >
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control" id="invoice_by" name="invoice_by">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Special Instructions</label>
															<div class="col-md-9">
																<select class="form-control" id="special_ins" name="special_ins">
																	<option>Thirdparty Inspection<option>
																	<option>Weight and Quality Supervision</option>
																</select>
																<span for="special_ins" class="help-block"></span>
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Attendance Placed</label>
															<div class="col-md-9">
