								...
								<!--<div class="btn-group">
									...
									<div class="portlet-body form">
										...
										<input type="hidden" name="load_ledger_csv" value="1">
											...
											<?php if (@$_GET['msg']==5) { echo '<font size="4" color="red">Invoice No Not Specified, File is not Uploaded!!!</font>'; } ?>
											<?php if (@$_GET['msg']==6) { echo '<font size="4" color="red">Ledger No Not Specified, File is not Uploaded!!!</font>'; } ?>
											<?php if (@$_GET['msg']==7) { echo '<font size="4" color="red">Ledger Amount Not Specified, File is not Uploaded!!!</font>'; } ?>
											<?php if (@$_GET['msg']==8) { echo '<font size="4" color="red">Ledger Type Credit or Debit is Not Specified, File is not Uploaded!!!</font>'; } ?>
											<?php if (@$_GET['msg']==9) { echo '<font size="4" color="red">Invoice Amount is not correct, File is not Uploaded!!!</font>'; } ?>
											<?php if (@$_GET['msg']==10) { echo '<font size="4" color="red">No Credit Entry Exists, File is not Uploaded!!!</font>'; } ?>
											<?php if (@$_GET['msg']==11) { echo '<font size="4" color="red">Debit Amount is Greater than Credit Balance Amount, File is not Uploaded!!!</font>'; } ?>
											<div class="form-body">
