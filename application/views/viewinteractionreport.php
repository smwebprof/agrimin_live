				...
				<div class="col-md-12">
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i>Client Interaction Reports
							</div>
							<div class="actions">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<?php if ($this->data['access_right']['view_rights'] == 1) { ?>
								<th>
									 View
								</th>
							    <?php } ?>
						    ...
						    <tr class="odd gradeX">
								...
								<td>
									<span class="label label-sm label-info">
										 <a href="<?php echo BASE_PATH; ?>fullviewinteractionreport?id=<?php echo base64_encode($interaction_data['id']); ?>"  style="color:#fff">View Report</a>
									</span>
