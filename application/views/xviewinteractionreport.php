										...
										<form action="" method="post" class="form-horizontal newclientinteraction-form" enctype="multipart/form-data">
											...
											<div class="form-body">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Mobile/Office Number</label>
															<div class="col-md-9">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<label class="control-label col-md-6"><?php echo $interaction_data['interaction_date']; ?></label>
															</div>
														</div>
													</div>
													<div class="col-md-6">
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<div class="col-md-9">
																<label class="control-label col-md-6"><a href="<?php echo $interaction_data['purpose_of_meeting_achieved_path']; ?>"><?php echo $interaction_data['purpose_of_meeting_achieved_path']; ?></a></label>
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															<label class="control-label col-md-3">View Attachment</label>
															<div class="col-md-9">
																<label class="control-label col-md-6"><a href="<?php echo $interaction_data['action_tobe_taken_to_achieve_said_purpose_path']; ?>"><?php echo $interaction_data['action_tobe_taken_to_achieve_said_purpose_path']; ?></a></label>
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															<label class="control-label col-md-3">View Attachment</label>
															<div class="col-md-6">
																<label class="control-label col-md-6"><a href="<?php echo $interaction_data['team_aci_followup_with_client_path']; ?>"><?php echo $interaction_data['team_aci_followup_with_client_path']; ?></a></label>
															</div>
														</div>
													</div>
													<!--/span-->
