								...
								<!--<div class="btn-group">
									...
									<div class="portlet-body form">
										...
										<form action="" method="post" class="form-horizontal accessmaster-form">
											...
											?>	
											<input type="hidden" class="form-control" placeholder="" name="user_id" id="user_id" value="<?php echo $user_details['id'];?>">	
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="user_type" id="user_type" value="<?php echo $user_details['employee_staff']; ?>">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="user_name" id="user_name" value="<?php echo $user_details['first_name']; ?>">
