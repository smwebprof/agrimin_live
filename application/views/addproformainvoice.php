								...
								<div class="portlet box blue">
									...
									<div class="portlet-body form">
										...
										<form action="" method="post" class="form-horizontal proformainvoice-form">
											...
											?>
											<?php /*<input type="hidden" name="file_id" id="file_id" value="<?php echo $invoice_data['id']; ?>">*/ ?>
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="postal_code" id="postal_code" value="" readonly>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="company_country" id="company_country" value="" readonly>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="company_state" id="company_state" value="" readonly>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="company_city" id="company_city" value="" readonly>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																<input type="text" class="form-control" name="inspection_start_date" id="inspection_start_date" value="" readonly>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="-6m" data-date-end-date="0d">
																<input type="text" class="form-control" name="inspection_end_date" id="inspection_end_date" value="" readonly>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="vessel_name" id="vessel_name" value="">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="voyage_no" id="voyage_no" value="">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<textarea class="form-control" rows="3" name="invoice_remarks" id="invoice_remarks" maxlength="200"></textarea>
															</div>
														</div>
													</div>
													<!--<div class="col-md-6">
													...
													<div class="col-md-12">
														...
														<div class="table-scrollable">
															...
															<tr class="active">
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="cargo_quantity[]" id="cargo_quantity" value="" onkeyup="cargo_amount2(this);" required>
																...
																<td>
																	 <input type="text" class="form-control input-small cargo_origin" id="cargo_origin" name="cargo_origin[]" value="" required>
																	 <span for="cargo_origin" class="help-block" style="color:red"></span>
																</td>
																<td>
																	 <input type="text" class="form-control input-small cargo_load_port" id="cargo_load_port" name="cargo_load_port[]" value="" required>
																	 <span for="cargo_load_port" class="help-block" style="color:red"></span>
																</td>
																<td>
																	 <input type="text" class="form-control input-small cargo_discharge_port" id="cargo_discharge_port" name="cargo_discharge_port[]" value="" required>
																	 <span for="cargo_discharge_port" class="help-block" style="color:red"></span>
																</td>
																<td>
																	 <input type="text" class="form-control input-small cargo_place_attendance" id="cargo_place_attendance" name="cargo_place_attendance[]" value="" required>
																	 <span for="cargo_place_attendance" class="help-block" style="color:red"></span>
																</td>														
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="cargo_rate[]" id="cargo_rate" value="" onkeyup="cargo_amount2(this);" required>
																	 <span for="cargo_rate" class="help-block" style="color:red"></span>
																</td>
																<td>
																	 <input type="text" class="form-control input-small invitems_amt" placeholder="" name="cargo_amt[]" id="cargo_amt" value="" required>
											 ...
											 <div class="row">
													<div class="col-md-12">
														...
														<div class="table-scrollable">
															...
															<tr class="active">
																<td>
																	<input type="text" class="form-control input-large" placeholder="" name="invitems_cargo_name[]" id="invitems_cargo_name" value="">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="invoice_total_vat_percnt" id="invoice_total_vat_percnt" value="">
