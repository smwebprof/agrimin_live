							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>Client Interaction Form
										</div>
										<div class="actions">
										<a href="<?php echo BASE_PATH; ?>addcargogroupmaster" class="btn red">
											...
											<div class="form-body">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Company/Clients</label>
															<div class="col-md-4">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="interaction_clients" id="interaction_clients">
																	<?php
													                $rows = $this->data['clients_data'];

													                foreach($rows as $clients_data){ 
													                	echo '<option value='.$clients_data["client_id"].'>'.$clients_data["client_name"].'</option>';
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="company" id="company" value="">
																<span for="company" class="help-block"></span>
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<textarea class="form-control" rows="3" name="office_address" id="office_address"></textarea>
													...
													<!--<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">AWC/Contract</label>
															<div class="col-md-9">
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Mobile/Office No </label>
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="mobile_no" id="mobile_no">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="email_address" id="email_address">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="alt_no" id="alt_no">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="company_web" id="company_web">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																<input type="text" class="form-control" name="interaction_date" id="interaction_date" readonly>
												...
												<div class="row">
													<div class="col-md-9">
														...
														<label class="control-label col-md-3">When will Team ACI followup with client?</label>	
