															...
															<div class="col-md-9">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="ledger_file_no" id="ledger_file_no">
													                ...
													                foreach($rows as $files_data){ 													                	
													                	if (@$this->data['post_ledger_file_no']==$files_data["file_no"]) {
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="ledger_invoice_amt" id="ledger_invoice_amt" value="<?php echo @$this->data['post_invoice_amt']; ?>" readonly>
																<span for="ledger_invoice_amt" class="help-block"></span>
															</div>
														</div>
													</div>
													<!--/span-->
