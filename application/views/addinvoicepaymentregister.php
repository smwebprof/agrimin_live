								...
								<?php /*<a href="<?php echo BASE_PATH; ?>Operationfileregister?id=<?php echo $_GET['id']; ?>" class="btn default yellow-stripe">
									...
									<div class="portlet-body form">
										...
										<form action="" method="post" class="form-horizontal payinvfileregister-form">
											...
											?>
											<?php if (@$_GET['msg']==1) { echo '<font size="3" color="red">Balance Amount is not valid</font>'; } ?>
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="other_charges" id="other_charges" value="">
																<span for="other_charges" class="help-block"></span>
															</div>
														</div>
													</div>
													<!--/span-->		
