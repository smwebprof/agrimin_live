												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="mail_name" id="mail_name">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																...
																<input type="checkbox" class="form-control" name="mail_active" id="mail_active" value="1">
