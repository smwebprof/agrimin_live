				...
				<div class="col-md-12">
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Credit Note Report - Full View
							</div>
							<!--<div class="tools">
							...
							<div class="actions">
								...
								<a href="<?php echo BASE_PATH; ?>Fullviewperfinvoicefilereportpdf_CH?id=<?php echo base64_encode($this->data['id']); ?>" class="btn green" target="_blank">
									<i class="fa fa-pencil"></i>Proforma Credit Note Report
								</a>
								<?php } else { ?>
								...
								<?php }*/ ?>
								<?php if ($_SESSION['country_code']=='CH')  { ?>
								<a href="<?php echo BASE_PATH; ?>Fullviewcreditinvoicereportpdf_CH?id=<?php echo $_GET['id']; ?>" class="btn default yellow-stripe" target="_blank">
									<i class="fa fa-plus"></i>
									<span class="hidden-480">
								...
								<?php } else { ?>
								<a href="<?php echo BASE_PATH; ?>Fullviewcreditinvoicereportpdf?id=<?php echo $_GET['id']; ?>" class="btn default yellow-stripe" target="_blank">
									<i class="fa fa-plus"></i>
									<span class="hidden-480">
										 View/Print Credit Note
									</span>
						...
						<div class="portlet-body">
							...
							<?php if (!empty($invoice_data['credit_note_no']))	{ ?>
							<tr>
								<td width="50%">
									 <strong>Credit Note No</strong>
								</td>
								<td>
									<?php echo $invoice_data['credit_note_no']; ?>
								</td>
							</tr>
							<?php } ?>
							<tr>
					...
					<!-- Start PORTLET-->
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
									<?php echo @$invoice_data['credit_remarks']; ?>
								</td>
							</tr>
							</table>
						</div>
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Credit Note Parameters
							</div>
						</div>
						<div class="portlet-body">
					...
					<!-- Start PORTLET-->
						...
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Credit Note Amount
							</div>
						</div>
						<div class="portlet-body">
							<table class="table table-hover table-striped table-bordered">
							...
							<tr>
								...
								<td>
									<?php echo $invoice_data['credit_note_ex_rate']; ?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $invoice_data['credit_note_basic_amt']; ?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $invoice_data['credit_note_vat_percent']; ?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $invoice_data['credit_note_tax_amt']; ?>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<?php echo $invoice_data['credit_note_amt']; ?>
								</td>
							</tr>
							</table>
						</div>
