								...
								<?php } ?>
									...
									<div class="portlet-body form">
										...
										<form action="" method="post" class="form-horizontal editinvoicefileregister-form">
											...
											<?php if (@$_GET['msg']==4) { echo '<font size="3" color="red">Entered Invoice Quantity is Greater Than Total Balance Quantity!!!</font>'; } ?>

											<?php if (@$_GET['msg']==5) { echo '<font size="3" color="red">Total Balance Quantity is Greater Than Total Invoice Quantity!!!</font>'; } ?>
											...
											<input type="hidden" name="invoice_discount_amt" id="invoice_discount_amt" value="<?php echo $invoice_data['invoice_discount_amt']; ?>">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															&nbsp;&nbsp;&nbsp;<input type="checkbox" name="para1_check" id="para1_check" value="1" <?php if($invoice_data['para_check1']==1) { echo 'checked';} ?>>
															&nbsp;&nbsp;&nbsp;<input type="text" name="para1_title" id="para1_title" value="Select This if Applicable" readonly>
															<div class="col-md-9">
																<textarea class="form-control" rows="3" name="cert_para1" id="cert_para1" maxlength="1200"><?php echo $invoice_data['para_text1']; ?></textarea>
															...
															<div class="table-responsive">
															   ...
															   <tr class="active">
																...
																<tr class="active">
																	...
																	<td>
																		 <input type="text" class="form-control" placeholder="" name="cargo_group" id="cargo_group" value="<?php echo $invoice_data['cargo_group']; ?>">
																	</td>
																</tr>
																<tr class="active">
																	<td>
																	...
																	<td>
																		 <input type="text" class="form-control" placeholder="" name="cargo_master" id="cargo_master" value="<?php echo $invoice_data['cargo_master']; ?>">
																	</td>
																</tr>
																<?php /*<tr class="active">
																	<td>
																...
																<tr class="active">
																	...
																	<td>
																		 <div class="checkbox-list"><label class="checkbox-inline"><input type="text" class="form-control" id="invoice_curr_bal" name="invoice_curr_bal" value="<?php echo $invoice_data['invoice_curr_bal']; ?>" readonly></label><label class="checkbox-inline"><input type="text" class="form-control" id="invoice_curr_unit" name="invoice_curr_unit" value="<?php echo $invoice_data['approx_unit']; ?>" readonly></label></div>
																	</td>
																</tr>				
																<tr class="active">
																	<td>
											   ...
											   <?php } ?>	
												...
												<div class="row">
													<div class="col-md-12">
														...
														<input type="hidden" name="invitems_file_cargo_id[]" id="invitems_file_cargo_id" value="<?php echo $cargo_details['file_cargo_id']; ?>">
														...
														<div class="table-scrollable">
															...
															<tr class="active">
																<td>
																	<input type="text" class="form-control input-large" placeholder="" name="invitems_cargo_name[]" id="invitems_cargo_name" value="<?php echo $cargo_details['work_type']; ?>" required readonly>
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="invitems_discount[]" id="invitems_discount" value="<?php echo $cargo_details['invoice_work_discount'];?>" onkeyup="cargo_discount(this);">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="number" class="form-control" placeholder="" name="invoice_total_discount" id="invoice_total_discount" value = "<?php echo $invoice_data['invoice_discount']; ?>">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="number" class="form-control" placeholder="" name="invoice_total_disc_amt" id="invoice_total_disc_amt" value = "<?php echo $invoice_data['invoice_discount_amt']; ?>" readonly>
