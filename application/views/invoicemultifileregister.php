							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box blue">
									<div class="portlet-title">
										...
										<div class="actions">
								<?php /*<a href="<?php echo BASE_PATH; ?>invoicemultifileregister?id=<?php echo $_GET['id']; ?>" class="btn default yellow-stripe">
								...
								<a href="<?php echo BASE_PATH; ?>Operationfileregister?id=<?php echo $_GET['id']; ?>" class="btn default yellow-stripe">
									...
									<div class="portlet-body form">
										...
										<form action="" method="post" class="form-horizontal invoicefileregister-form">
											...
											<?php if (@$_GET['msg']==2) { echo '<font size="3" color="red">Entered Invoice Quantity is Greater Than Total Balance Quantity of File !!!</font>'; } ?>
											...
											<input type="hidden" name="invoice_info" id="invoice_info" value="Multiple">
											<input type="hidden" name="inv_quantity" id="inv_quantity" value="<?php echo $this->data['tot_quantity']; ?>">
											<div class="form-body">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-6">
																<div class="input-group input-medium date date-picker" data-date-format="dd-mm-yyyy" data-date-start-date="-2y" data-date-end-date="0d">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Nett Deductions</label>
															&nbsp;&nbsp;&nbsp;<input type="hidden" name="para1_check" value="0">
															&nbsp;&nbsp;&nbsp;<input type="checkbox" name="para1_check" id="para1_check" value="1">
															&nbsp;&nbsp;&nbsp;<input type="text" name="para1_title" id="para1_title" value="Select This if Applicable" readonly>
															<div class="col-md-9">
																<textarea class="form-control" rows="3" name="cert_para1" id="cert_para1" maxlength="1200">Nett of Any  Applicable Tax Deductions</textarea>
											...
											<div class="row">
														...
														<div class="portlet-body">
															<div class="table-responsive">
																...
																<tr class="active">
																	...
																	<td>
																		 <input type="text" class="form-control" placeholder="" name="scope_work" id="scope_work" value="<?php echo $invoice_data['scope_work']; ?>">
																	</td>
																</tr>
															   <?php } ?>
																<?php if ($invoice_data['file_no_type']=='Inspection') { ?>
																<tr class="active">
																	...
																	<td>
																		 <input type="text" class="form-control" placeholder="" name="warehouse" id="warehouse" value="<?php echo $invoice_data['warehouse']; ?>">
																	</td>
																</tr>
															   <?php } else { ?>
															   <tr class="active">
																...
																<tr class="active">
																	...
																	<td>
																		 <input type="text" class="form-control" placeholder="" name="cargo_group" id="cargo_group" value="<?php echo $this->data['cargo_group_name']; ?>">
																	</td>
																</tr>
																<tr class="active">
																	<td>
																	...
																	<td>
																		 <input type="text" class="form-control" placeholder="" name="cargo_master" id="cargo_master" value="<?php echo $this->data['commodity_name']; ?>">
																	</td>
																</tr>
																<tr class="active">
																	<td>
																	...
																	<td>
																		 <div class="checkbox-list"><label class="checkbox-inline"><input type="text" class="form-control" id="inv_quantity_org" name="inv_quantity_org" value="<?php echo $this->data['tot_quantity_org']; ?>" readonly></label><label class="checkbox-inline"><input type="text" class="form-control" id="inv_quantity_unit" name="inv_quantity_unit" value="<?php echo $this->data['tot_unit']; ?>" readonly></label></div>
																	</td>
																</tr>
																<tr class="active">
																	<td>
																		 <font color="red">Balance Quantity</font>
																	</td>
																	<td>
																		 <div class="checkbox-list"><label class="checkbox-inline"><input type="text" class="form-control" id="invoice_curr_bal" name="invoice_curr_bal" value="<?php echo $this->data['tot_quantity']; ?>" readonly></label><label class="checkbox-inline"><input type="text" class="form-control" id="invoice_curr_unit" name="invoice_curr_unit" value="<?php echo $this->data['tot_unit']; ?>" readonly></label></div>
																	</td>
																</tr>
																<tr class="active">
																	<td>
											 ...
											 ?>
												...
												<div class="row">
													<div class="col-md-12">
														...
														<input type="hidden" name="invitems_file_cargo_id[]" id="invitems_file_cargo_id" value="<?php echo $cargo_details['id']; ?>">
														<?php /*<input type="button" value="Add Cargo Particulars" id="invoice_cargo_item_<?php echo $i; ?>" class="invoice_cargo_item" OnClick="javascript:cargo_rows(<?php echo $i; ?>);">*/ ?>
														<div class="table-scrollable">
															...
															<tr class="active">
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="invitems_rate[]" id="invitems_rate" value="0" onkeyup="cargo_amount3(this);" required>
																	 <span for="invitems_rate" class="help-block" style="color:red"></span>
																</td>
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="invitems_discount[]" id="invitems_discount" value="" onkeyup="cargo_discount(this);">
																	 <span for="invitems_discount" class="help-block" style="color:red"></span>
																</td>
																<td>
														...
														<div class="table-scrollable">
															...
															<tr class="active">
																<td>
																	...
																	<input type="hidden" class="form-control input-large" placeholder="" name="invitems_cargo_details[]" id="invitems_cargo_details" value="invitems_cargo_details|<?php echo $i; ?>" >									
																	<input type="hidden" name="invitems_cargo_group[]" id="invitems_cargo_group" value="Other">
																	<span for="invitems_cargo_name" class="help-block" style="color:red"></span>
																</td>
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="invitems_quantity[]" id="invitems_quantity" value="" onkeyup="cargo_amount4(this);" required>
																	 <span for="invitems_quantity" class="help-block" style="color:red"></span>
																</td>																	
																<td>
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="invitems_rate[]" id="invitems_rate" value="0" onkeyup="cargo_amount4(this);" required>
																	 <span for="invitems_rate" class="help-block" style="color:red"></span>
																</td>
																<td>
																	 <input type="text" class="form-control input-small invitems_amt" placeholder="" name="invitems_amt[]" id="invitems_amt" value="" required>
											 ...
											 <div class="form-actions top right">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3"><font color="red">Discount (%)</font></label>
															<div class="col-md-9">
																<input type="number" class="form-control" placeholder="" name="invoice_total_discount" id="invoice_total_discount">
																<span for="invoice_total_discount" class="help-block"></span>
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3"><font color="red">Discount Amount</font></label>
															<div class="col-md-9">
																<input type="number" class="form-control" placeholder="" name="invoice_total_disc_amt" id="invoice_total_disc_amt" readonly>
																<span for="invoice_total_disc_amt" class="help-block"></span>
															</div>
														</div>
													</div>
													<!--/span-->
