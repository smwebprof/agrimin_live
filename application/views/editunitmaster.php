								...
								<!--<div class="btn-group">
									...
									<div class="portlet-body form">
										...
										<form action="" method="post" class="form-horizontal unitmaster-form">
											...
											?>
											<?php $rows = $this->data['unit_data'];
										
											foreach($rows as $unit_data){
											?>
											<input type="hidden" name="id" id="id" value="<?php echo $unit_data['id']; ?>">
											<div class="form-body">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="unit_name" id="unit_name" value="<?php echo $unit_data['unit_name']; ?>">
												...
												<?php /*<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<textarea class="form-control" rows="3" name="description"><?php echo $unit_data['description']; ?></textarea>
