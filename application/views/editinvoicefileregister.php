													...
													<div class="col-md-12">
														...
														<div class="table-scrollable">
															...
															<tr class="active">
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="invitems_quantity[]" id="invitems_quantity" value="<?php echo $cargo_details['approx_qty'];?> " onkeyup="cargo_amount4(this);" required>
																	 <span for="invitems_quantity" class="help-block" style="color:red"></span>
																</td>																	
																<td>
																	 <select class="form-control input-small" data-placeholder="Select..." name="invitems_unit[]" id="invitems_unit">
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="invitems_rate[]" id="invitems_rate" value="<?php echo $cargo_details['invoice_work_rate'];?>" onkeyup="cargo_amount4(this);">
																	 <span for="invitems_rate" class="help-block" style="color:red"></span>
																</td>	
																<td>
																	 <input type="text" class="form-control input-small invitems_amt" placeholder="" name="invitems_amt[]" id="invitems_amt" value="<?php echo $cargo_details['invoice_work_amount'];?>" required>
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="number" class="form-control" placeholder="" name="invoice_total_vat_percnt" id="invoice_total_vat_percnt" value = "<?php echo $invoice_data['invoice_vat_percent']; ?>" <?php if ($invoice_data['tax_options']=='N/A') { echo 'readonly';} ?> <?php if ($invoice_data['tax_options']=='VAT') { echo 'required';} ?>>
