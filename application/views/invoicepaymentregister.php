								...
								<a href="<?php echo BASE_PATH; ?>Operationfileregister?id=<?php echo $_GET['id']; ?>" class="btn default yellow-stripe">
									...
									<div class="portlet-body form">
										...
										<form action="" method="post" class="form-horizontal payinvfileregister-form">
											...
											?>
											<input type="hidden" name="invoice_file_no" id="invoice_file_no" value="">
											<div class="form-body">
															...
															<div class="col-md-9">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="invoice_no" id="invoice_no">
													                ...
													                foreach($rows as $invoice_data){ 
													                	echo '<option value='.$invoice_data["id"].'>'.$invoice_data["id"].'</option>';
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="hidden" class="form-control" placeholder="" name="client_id" id="client_id" value="">
																<input type="text" class="form-control" placeholder="" name="client_name" id="client_name" value="">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="cheque_date" id="cheque_date" value="">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="invoice_amt" id="invoice_amt" value="">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="invoice_basic_amt" id="invoice_basic_amt" value="">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="invoice_balane_amt" id="invoice_balane_amt" value="">
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="vat_percent" id="vat_percent" value="">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<input type="text" class="form-control" placeholder="" name="vat_amt" id="vat_amt" value="">
