			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					File Register - Full View - Multiple Cargo Group
					</h3>
						...
						<div class="row">
													<div class="col-md-12">
														...
														<div class="table-scrollable">
															...
															<tr class="active">
																<td>
																	 <select class="form-control input-small cargomaster" name="cargo_group[]" id="cargo_group" title="<?php echo $v['cargo_group_name']; ?>">
																	 <option value=""><?php echo $v['cargo_group_name']; ?></option>
																	 </select>
