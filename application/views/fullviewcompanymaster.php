			...
			<div class="row">
				<div class="col-md-12">
					...
					<ul class="page-breadcrumb breadcrumb">
						...
						<li>
							<a href="<?php echo BASE_PATH; ?>viewcompanymaster">
								Company Master
							</a>
							<i class="fa fa-angle-right"></i>
						</li>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="tabbable tabbable-custom boxless tabbable-reversed">
						...
						<?php $rows = $this->data['company_data'];
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
									&nbsp;&nbsp;<?php echo $company_data['country_code']; ?> <?php echo $company_data['telno']; ?>
								</td>
							</tr>
							<tr>
								<td>
