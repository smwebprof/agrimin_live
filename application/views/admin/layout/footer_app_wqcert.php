...
<script>
        ...
        jQuery(document).ready(function() {       
           ...
           Custom.initWQCertificateMaster();
        ...
        function cert_rows(i) { 
              j = 1;
              $('#cert_param_details_'+i+' tbody').append($('#cert_param_details_'+i+' tbody tr:last').clone());

              $('#cert_param_details_'+i+' tr').each(function(j) {
                  //alert(j);
                  ...
                  selectinput.eq(0).attr('id', 'wcert_params_' + i + j);
                  textinput.eq(0).attr('id', 'wcert_specs_'  + i + j);
                  ...
                  textinput2.eq(1).attr('id', 'wcert_results_'  + i + j);
                  //$('#qcert_results').val(j);
                  //j++;
              });  
