...
<div class="header navbar navbar-fixed-top mega-menu">
	...
	<div class="header-inner">
		...
		<ul class="nav navbar-nav pull-right">
			...
			<li class="dropdown" id="header_task_bar" style="margin-top: 12px; padding-right: 10px;"><strong>Financial Year</strong>
			<?php if ($_SESSION['employee_staff']!='Guest') { ?>
			<li class="dropdown" id="header_task_bar">
			...
			?>
			<li class="dropdown" id="header_task_bar" style="margin-top: 12px; padding-right: 10px;"><strong>Branch</strong>
			<?php if ($_SESSION['employee_staff']!='Guest') { ?>
