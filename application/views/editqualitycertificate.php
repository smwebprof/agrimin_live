												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															&nbsp;&nbsp;&nbsp;<input type="text" name="para1_title" id="para1_title" value="<?php if(!empty($certificate_data['para_title1'])) { echo $certificate_data['para_title1'];  } else { echo 'Title'; } ?>">
															...
															<div class="col-md-9">
																<textarea class="form-control" rows="3" name="cert_para1" id="cert_para1" maxlength="1200"><?php if(!empty($certificate_data['para_text1'])) { echo $certificate_data['para_text1'];  } else { echo 'WE AGRIMIN CONTROL INTERNATIONAL S.A. BEING A RECOGNIZED INTERNATIONAL INDEPENDENT SUPERVISION COMPANY AND MEMBER OF GAFTA THROUGH OUR ASSOCIATES IN ARGENTINA,DO HEREBY CERTIFY HAVING SAMPLED THE ABOVE PARCEL AT TIME AND PLACE OF LOADING.'; } ?></textarea>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															&nbsp;&nbsp;&nbsp;<input type="text" name="para2_title" id="para2_title" value="<?php if(!empty($certificate_data['para_title2'])) { echo $certificate_data['para_title2'];  } else { echo 'SAMPLING AND ANALYSIS'; } ?>">
															...
															<div class="col-md-9">
																<textarea class="form-control" rows="3" name="cert_para2" id="cert_para2" maxlength="1200"><?php if(!empty($certificate_data['para_text2'])) { echo $certificate_data['para_text2'];  } else { echo 'DURING LOADING SAMPLES WERE DRAWN FROM LOADING BELT AT NEAREST PRACTICABLE POINT TO THE VESSEL AS PER GAFTA RECOMMENDATIONS AND A SET OF COMPOSITE SAMPLES WERE COMPOSED AND SEALED REPRESENTING THE TOTAL CARGO.ONE SEALED SAMPLE WAS FORWARDED TO AN INDEPENDENT GAFTA LABORATORY, REFLECTING THE FOLLOWING RESULTS.'; } ?></textarea>
												...
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															...
															&nbsp;&nbsp;&nbsp;<input type="text" name="para3_title" id="para3_title" value="<?php if(!empty($certificate_data['para_title3'])) { echo $certificate_data['para_title3'];  } else { echo 'QUALITY'; } ?>">
															...
															<div class="col-md-9">
																<textarea class="form-control" rows="3" name="cert_para3" id="cert_para3" maxlength="1200"><?php if(!empty($certificate_data['para_text3'])) { echo $certificate_data['para_text3'];  } else { echo 'REPRESENTATIVE SAMPLES WERE DRAWN DURING LOADING OPERATIONS AND A COMPOSITE SAMPLES WAS SUBMITTED FOR ANALYSIS WITH THE FOLLOWING RESULTS,ALL FINAL AT THE MOMENT OF SHIPMENT.'; } ?></textarea>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															&nbsp;&nbsp;&nbsp;<input type="text" name="para4_title" id="para4_title" value="<?php if(!empty($certificate_data['para_title4'])) { echo $certificate_data['para_title4'];  } else { echo 'TITLE'; } ?>">
