<style> 
							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box green">
									<div class="portlet-title">
										...
										<a href="<?php echo BASE_PATH; ?>Viewfileregister_test" class="btn red">
									...
									<div class="portlet-body form">
										...
										<form id="fileregister-form" action="" method="post" class="form-horizontal addfileregister-form" enctype="multipart/form-data" onsubmit="submitForm()">
										<input type="hidden" id="file_save_button" name="file_save_button" value="">
	...
	?>
												...
												<?php /*<h3 class="form-section alert alert-info">Other Details</h3>
												<!--/row-->
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
												...
												<font style="color:red">***Instructions : Select Cargo Group and then Add No of Cargo Products As Required...</font><br/><br/>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label class="control-label col-md-3">Cargo Group*</label>
															<div class="col-md-9">
																<select class="form-control input-large select2me" data-placeholder="Select..." name="cargo_group_new" id="cargo_group_new">
																	<option value="">Select</option>
																	<?php
													                $cargo_group = $this->data['cargogroup'];
																...
																<span for="cargo_group_new" class="help-block"></span>
															</div>
														</div>
													</div>
													<!--/span-->
												...
												<div class="row">
													<div class="col-md-12">
														...
														<input type="button" value="Add Cargo Product" id="cargo_row">
														<div class="table-scrollable">
															...
															<tr class="active">
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="div_quantity[]" id="div_quantity" value="" >
																</td>
																<td width="100%">
																...
																<td>
																	 <input type="text" class="form-control input-small div_gross_wt" placeholder="" name="div_vessel_name[]" id="div_vessel_name" value="">
																</td>
																<td>
																	 <input type="text" class="form-control input-small div_tare_wt" id="div_voyage_no" name="div_voyage_no[]" value="">
																</td>
																<td>
																	 <input type="text" class="form-control input-small div_origin" id="div_origin" name="div_origin[]" value="">
																</td>
																<td>
																	 <input type="text" class="form-control input-small div_container_wt" id="div_load_port" name="div_load_port[]" value="">
																</td>
																<td>
																	 <input type="text" class="form-control input-small div_net_wet" id="div_discharge_port" name="div_discharge_port[]" value="">
																</td>
																<td>
																	 <input type="text" class="form-control input-small div_net_wet" id="div_place_attendance" name="div_place_attendance[]" value="">
																</td>																
															</tr>															
															</tbody>
															</table>
												...
												<div class="row">
													<div class="col-md-6">
														<?php /*<div class="col-md-offset-9 col-md-9">
															<button type="button" class="btn red file_save" value="save" id="file_save" name="file_save">Save</button>&nbsp;&nbsp;&nbsp;
														...
														<div class="col-md-offset-9 col-md-9">
															<button type="button" class="btn red file_save" value="save" id="file_save" name="file_save">Save</button>&nbsp;&nbsp;&nbsp;
															<button type="Save" class="btn green"  value="submit">Submit</button>&nbsp;&nbsp;&nbsp;
