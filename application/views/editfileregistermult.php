														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<select class="form-control" name="scope_services" id="scope_services">
																	...
																	<option value="Discharge Supervision" <?php if ($file_data['scope_of_services']=='Discharge Supervision') { echo 'selected'; } ?>>Discharge Supervision</option>
																	<option value="Technical Inspection" <?php if ($file_data['scope_of_services']=='Technical Inspection') { echo 'selected'; } ?>>Technical Inspection</option>
																</select>
													...
													<div class="col-md-12">
														...
														<div class="table-scrollable">
															...
															<tr class="active">
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="div_quantity[]" id="div_quantity_<?php echo $i; ?>" value="<?php echo $v['approx_qty']; ?>" <?php /*if (@$this->data['invoice_flag']==1) { echo 'readonly';}*/ ?>>
																</td>
																<td>
