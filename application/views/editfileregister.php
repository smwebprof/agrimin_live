													...
													<div class="col-md-12">
														...
														<div class="table-scrollable">
															...
															<tr class="active">
																...
																<td>
																	 <input type="text" class="form-control input-small" placeholder="" name="div_quantity[]" id="div_quantity" value="<?php echo $v['approx_qty']; ?>" <?php /*if (@$this->data['invoice_flag']==1) { echo 'readonly';} */?>>
																</td>
																<td>
