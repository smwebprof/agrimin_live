							...
							<div class="tab-pane active" id="tab_0">
								<div class="portlet box blue">
									<div class="portlet-title">
										<div class="caption">
											<i class="fa fa-reorder"></i>New Client Interaction
										</div>
									...
									<div class="portlet-body form">
										...
										*Fields are mandatory
										...
										<input type="hidden" name="new_client_interaction" id="new_client_interaction" value="new_client_interaction">	
											<?php
												   #print_r($this->data);
												   /*echo validation_errors();
												   if (isset($this->data['success']))
														...
														<div class="form-group">
															...
															<div class="col-md-9">
																<div class="checkbox-list">
																	...
																	<input type="number" class="form-control" id="int_office_prefix" name="int_office_prefix" placeholder="Country Code" style="width:200px;"></label>
																	<label class="checkbox-inline">
																	<input type="number" class="form-control" name="int_office_no" id="int_office_no" placeholder="Office Number">
																	</label>
																</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<div class="checkbox-list">
																	<label class="checkbox-inline">
																	<input type="number" class="form-control" id="int_mobile_prefix" name="int_mobile_prefix" placeholder="Country Code" style="width:200px;"></label>
																	<label class="checkbox-inline">
																	<input type="number" class="form-control" name="int_mobile_no" id="int_mobile_no" placeholder="Mobile Number">
																	</label>
																</div>
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<div class="col-md-9">
																<div class="checkbox-list">
																	<label class="checkbox-inline">
																	<input type="number" class="form-control" id="int_alt_prefix" name="int_alt_prefix" placeholder="Country Code" style="width:200px;"></label>
																	<label class="checkbox-inline">
																	<input type="number" class="form-control" name="int_alt_no" id="int_alt_no" placeholder="Mobile Number">
																	</label>
																</div>
												...
												<div class="row">
													...
													<div class="col-md-3">
														<div class="form-group">
															...
															<br>
																<span>*Only pdf,doc,xls accepted.Files upto 2MB only accepted</span><br>
															</div>
														</div>
													</div>
													<!--/span-->
