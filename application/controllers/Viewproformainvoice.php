...
class Viewproformainvoice extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['title'] = 'ACI - viewproformainvoice';
		#$this -> load -> model('campaign_model');
		
		$this->data['layout_body']='viewproformainvoice';

		$result = $this->Invoice_master->getAllProformaInvoicedata();
		//print_r($result);exit;
