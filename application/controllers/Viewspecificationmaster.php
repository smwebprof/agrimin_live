...
class Viewspecificationmaster extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['title'] = 'ACI - Viewspecificationmaster';
		#$this -> load -> model('campaign_model');
		
		$this->data['layout_body']='viewspecificationmaster';

		$result = $this->Lab_master->getlabspecificationslist();
		//print_r($result);exit;
