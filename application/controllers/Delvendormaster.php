...
class Delvendormaster extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['title'] = 'ACI - Delvendormaster';
		#$this -> load -> model('campaign_model');
		
		$this->data['layout_body']='delvendormaster';

		$result = $this->Vendor_master->delvendormaster($id);

		########################### Log Activity ######################################
            $this->load->model('Activity_master');
            $params['module'] = 'delvendormaster';
            $params['date_time'] = $dt;
        ...
        ##################################################################
 		...
 		$viewinteractions = BASE_PATH."Viewvendormaster?msg=2";
