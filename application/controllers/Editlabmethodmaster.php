...
class Editlabmethodmaster extends CI_Controller {
	...
	public function index()
	{
        ...
        if (@$_POST) {
        	...
        	$resultdata = $this->Lab_master->updatelabmethods($_POST);
        	...
        	$result = $this->Lab_master->geteditlabMethods($id);
        	#print_r($result);exit;
        	$branchs = $this->Branch_master->getBranchdata();
        	#print_r($branchs);exit;

   			$this->data['title'] = 'ACI - Editlabmethodmaster';
			#$this -> load -> model('campaign_model');
			
			$this->data['layout_body']='editlabmethodmaster';
			$this->data['method_data'] = $result;
