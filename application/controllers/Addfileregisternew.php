...
class Addfileregisternew extends CI_Controller {
        ...
        if ($_POST) {
        	...
        	if ($resultdata) {
				...
				$file_email_report .= '<table width="100%" cellpadding="0" border="1">
		          		 <tr><td align="center"><b>FILE NO</b></td><td align="center"><b>CREATED ON</b></td><td align="center"><b>CREATED BY</b></td><td align="center"><b>CLIENT NAME</b></td><td align="center"><b>CARGO</b></td><td align="center"><b>VESSEL NAME</b></td><td align="center"><b>QUANTITY</b></td><td align="center"><b>UNIT</b></td><td align="center"><b>TYPE OF JOB</b></td></tr>
		          		 <tr><td align="center">'.$email_file_no.'</td><td align="center">'.$email_file_date.'</td><td align="center">'.$email_file_user.'</td><td align="center">'.$email_client_name.'</td><td align="center">'.$email_commodity.'</td><td align="center">'.$email_vessel.'</td><td align="center">'.$email_qty.'</td><td align="center">'.$email_unit.'</td><td align="center">'.$email_jobtype.'</td>
		          		 </tr></table>';
        		...
        		$email_cc[] = 'prashant.joshi@rcaindia.net';
				$email_cc[] = 'namrata@rcaindia.net';
	...
	///////////////////////////////////////////////////////////////////////////////
			$this->data['layout_body']='addfileregisternew';
			...
			$this->data['createinvoice']=$createinvoice;
	 		$this->load->view('admin/layout/main_app_file_test', $this->data);
