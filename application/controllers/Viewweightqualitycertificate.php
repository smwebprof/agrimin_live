...
class Viewweightqualitycertificate extends CI_Controller {
	...
	public function index()
	{
		...
		if (@$_POST) {
			...
			$this->data['title'] = 'ACI - Viewweightqualitycertificate';
			#$this -> load -> model('campaign_model');
			
			$this->data['layout_body']='Viewweightqualitycertificate';
			...
			$result = $this->Weight_Quality_master->getAllWQCertificatedata();
			//print_r($result);exit;
        	...
        	//echo $cert_data;exit;
        	$cert_details = $this->Weight_Quality_master->getWQCertificatedetails($cert_data);
       		}
       		//print_r($cert_details);exit;
