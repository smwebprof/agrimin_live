...
class Dellabmethodmaster extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['title'] = 'ACI - Lab Master';
		#$this -> load -> model('campaign_model');
		
		$this->data['layout_body']='dellabmethodmaster';

		$result = $this->Lab_master->dellabmethodmaster($id);

		########################### Log Activity ######################################
            $this->load->model('Activity_master');
            $params['module'] = 'dellabmethodmaster';
            $params['date_time'] = $dt;
        ...
        ##################################################################
 		...
 		$viewinteractions = BASE_PATH."Viewlabmethodmaster";
