       ...
       #$logo = ASSETS_PATH.'img/agrilogo269x74.jpg';
        ...
        $pdf9 = '<table width="100%" cellpadding="0" border="0">
          ...
          foreach($data as $company_address){  
            if ($result[0]['file_id']<302 && $branch_details['sortname']=='SG') {  
              $pdf9 .= '<td width="50%">
                    <table width="100%" border="0">
                        <tr><td></td></tr>
                        <tr><td></td></tr>
                        <tr><td><b>'.$company_address['name'].'</b> , '.$branch_details['old_address'].'</td></tr>
              ...
              $pdf9 .= '<td width="50%">
                    <table width="100%" border="0">
                        <tr><td></td></tr>
                        <tr><td></td></tr>
                        <tr><td><b>'.$company_address['name'].'</b> , '.$branch_details['address'].'</td></tr>
        ...
        foreach($rows as $invoice_data){
          ...
          if (!empty($invoice_data['invoice_date'])) { $pdf3 .= '<tr><th><b>Inspection Date</b></th><th>'.$invoice_data['inspection_date'].'</th></tr>'; }
