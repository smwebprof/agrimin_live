...
class Downloadqualitycertificate extends CI_Controller {
    ...
    function index()
    {
            ...
            $html1 .= '<tr><td width="50%">Certificate No : '.$result[0]['certificate_no'].'</td><td></td><td width="40%"> Date : '.$result[0]['certificate_date'].'</td></tr>';
