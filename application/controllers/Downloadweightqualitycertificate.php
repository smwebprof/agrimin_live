...
class Downloadweightqualitycertificate extends CI_Controller {
    ...
    function index()
    {
            ...
            $pdf->Cell(174,60,'ORIGINAL',0,0,'R'); 
            ...
            $html .= '<br><br><br><br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<u><center>WEIGHT AND QUALITY CERTIFICATE - No - '.$result[0]['certificate_no'].'</center></u><br>';
            ...
            $html1 .= '<tr><td></td><td></td><td> Date : '.$result[0]['certificate_date'].'</td></tr>';
            $html1 .=  '</table><br><br>';
