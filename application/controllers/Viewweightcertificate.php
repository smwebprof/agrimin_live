...
class Viewweightcertificate extends CI_Controller {
	...
	public function index()
	{
		...
		if (@$_POST) {
			...
			$this->data['title'] = 'ACI - viewweightcertificate';
			#$this -> load -> model('campaign_model');
			
			$this->data['layout_body']='viewweightcertificate';
			...
			$result = $this->Weight_master->getAllWCertificatedata();
			//print_r($result);exit;
        	...
        	//echo $cert_data;exit;
        	$cert_details = $this->Weight_master->getWCertificatedetails($cert_data);
       		}
