...
class Viewlabmethodmaster extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['title'] = 'ACI - Viewlabmethodmaster';
		#$this -> load -> model('campaign_model');
		
		$this->data['layout_body']='viewlabmethodmaster';

		$result = $this->Lab_master->getlabMethods();
