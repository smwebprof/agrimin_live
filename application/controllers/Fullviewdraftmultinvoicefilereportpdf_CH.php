...
class Fullviewdraftmultinvoicefilereportpdf_CH extends CI_Controller {
   ...
   */
    ...
    {    
        ...
        $invoice_details_totcount = count($invoice_details);
        $invoice_details_count = count(array_chunk($invoice_details,12));
        $invoice_details_parts = array_chunk($invoice_details,12);
        ...
        $file_name = 'Invoice_'.$result[0]['invoice_no'].'.pdf';
          ...
          <tr>
              ...
              <td width="50%">
                  <table width="100%" border="0" align="left">
                      ...
                      <tr><td>'.$invoice_address.'</td></tr><tr><td>'.$invoice_data['city'].','.$invoice_data['state'];
              if (!empty(@$zipcode)) { $pdf1 .= ' ,Postal Code : '.@$zipcode; } 
              $pdf1 .= ','.$invoice_data['country'].'</td></tr>';        
          ...
          $pdf4 = '<br>'; 
          $x = 1;
          if ($invoice_details_count>1)  { 
            for($i=0;$i<$invoice_details_count;$i++) {
              if ($i==1) {
              $pdf4 .= '<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
              $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5">';
              if (!empty($invoice_data['file_no'])) { $pdf4 .= '<tr><th width="20%"><b>Job No</b></th><th width="80%">'.$invoice_data['file_no'].'</th></tr>'; }
              if (!empty($invoice_data['invoice_no'])) { $pdf4 .= '<tr><th width="20%"><b>Invoice No</b></th><th width="80%">'.$invoice_data['invoice_no'].'</th></tr>'; }
              $pdf4 .= '</table>';
              $pdf4 .= '<br><br><br>';
              }
              if ($i>1) {
              $pdf4 .= '<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
              $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5">';
              if (!empty($invoice_data['file_no'])) { $pdf4 .= '<tr><th width="20%"><b>Job No</b></th><th width="80%">'.$invoice_data['file_no'].'</th></tr>'; }
              if (!empty($invoice_data['invoice_no'])) { $pdf4 .= '<tr><th width="20%"><b>Invoice No</b></th><th width="80%">'.$invoice_data['invoice_no'].'</th></tr>'; }
              $pdf4 .= '</table>';
              ...
              if (count($cargo_group_arr)>1) { 
                if ($cargo_discount_flag==0) { 
                  ...
                  $pdf4 .=  '<tr><td width="7%"><b>Sr.No.</b></td><td width="18%"><b>Cargo Group</b></td><td width="35%"><b>Invoice Details</b></td><td width="14%"><b>Quantity</b></td><td width="14%"><b>Rate ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td><td width="14%"><b>Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td></tr>';
                  #$row_invoice = $invoice_details;
                  foreach($invoice_details_parts[$i] as $invoicedetails){
                    ...
                    $pdf4 .=  '<tr><td>'.$x.'</td><td align="left">'.$invoicedetails["cargo_group"].'</td><td align="left">'.htmlspecialchars($invoicedetails["work_type"]).'</td><td>'.$invoicedetails["approx_qty"].' '.$invoicedetails["approx_unit"].'</td>
                    <td>'.$invoicedetails["invoice_work_rate"].'</td><td>'.$invoicedetails["invoice_work_amount"].'</td></tr>';
                    $x++;    
                  }
                  if ($invoice_details_count==$i+1) { 
                  $invoice_ex_amt = $invoice_data["invoice_basic_amt"]*$invoice_data["invoice_ex_rate"];
                    ...
                    $pdf4 .=  '<tr><td></td><td align="left"><b>Basic Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].'):</b></td><td></td><td></td><td></td><td><b>'.$invoice_data["invoice_basic_amt"].'</b></td></tr>';
                    ...
                    if (!empty($invoice_tax_amt)) {
                          $pdf4 .=  '<tr><td></td><td align="left"><b>Tax Amount (VAT '.$invoice_data["invoice_vat_percent"].'%) :</b></td><td></td><td></td><td></td><td><b>'.$invoice_tax_amt.'</b></td></tr>';
                    }
                    $pdf4 .=  '<tr><td></td><td align="left"><b>Total Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].'):</b></td><td></td><td></td><td></td><td><b>'.sprintf('%.2f', $invoice_data["invoice_amt"]).'</b></td></tr>';
                    $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5" align="center">';
                          $pdf4 .=  '<tr><td width="102%"><b>Amount : - </b> '.$invoice_data["currency"].' '.strtoupper($this->numtowords(sprintf('%.2f', $invoice_data["invoice_amt"]),$invoice_data["subunit"])).'</td></tr>';
                          $pdf4 .=  '</table>'; 
                    } /***else {
                    if ($i==1) { 
                      $invoice_ex_amt = $invoice_data["invoice_basic_amt"]*$invoice_data["invoice_ex_rate"];
                              if (empty($invoice_data["invoice_tax_amt"])) { $invoice_tax_amt = ''; } else { $invoice_tax_amt = $invoice_data["invoice_tax_amt"]; }  
                        $pdf4 .=  '<tr><td></td><td align="left"><b>Basic Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].'):</b></td><td></td><td></td><td><b>'.$invoice_data["invoice_basic_amt"].'</b></td></tr>';
                        if (!empty($invoice_data["invoice_discount"])) {
                              $pdf4 .=  '<tr><td></td><td align="left"><b>Discount Amount (Discount '.$invoice_data["invoice_discount"].'%):</b></td><td></td><td></td><td><b>'.sprintf('%.2f', $invoice_data["invoice_discount_amt"]).'</b></td></tr>';
                        } 
                        if (!empty($invoice_tax_amt)) {
                              $pdf4 .=  '<tr><td></td><td align="left"><b>Tax Amount (VAT '.$invoice_data["invoice_vat_percent"].'%) :</b></td><td></td><td></td><td><b>'.$invoice_tax_amt.'</b></td></tr>';
                        }
                        $pdf4 .=  '<tr><td></td><td align="left"><b>Total Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].'):</b></td><td></td><td></td><td><b>'.sprintf('%.2f', $invoice_data["invoice_amt"]).'</b></td></tr>';
                        $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5" align="center">';
                              $pdf4 .=  '<tr><td width="102%"><b>Amount : - </b> '.$invoice_data["currency"].' '.strtoupper($this->numtowords($invoice_data["invoice_amt"],$invoice_data["subunit"])).'</td></tr>';
                              $pdf4 .=  '</table>';
                        } 
                    } ***/         
                  $pdf4 .= '</table>';
                  ...
                  $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5" align="center">';
                  $pdf4 .=  '<tr><td width="7%"><b>Sr.No.</b></td><td width="50%"><b>Invoice Details</b></td><td width="15%"><b>Quantity</b></td><td width="15%"><b>Rate ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td><td width="15%"><b>Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td></tr>';
                  #$row_invoice = $invoice_details;
                  foreach($invoice_details_parts[$i] as $invoicedetails){
                    if ($invoicedetails["approx_unit"]=='NONE') { $invoicedetails["approx_unit"] = ''; } 
                    if ($invoicedetails["invoice_work_rate"]==0) { $invoicedetails["invoice_work_rate"] = ''; }
                    $pdf4 .=  '<tr><td>'.$x.'</td><td align="left">'.htmlspecialchars($invoicedetails["work_type"]).'</td><td>'.$invoicedetails["approx_qty"].' '.$invoicedetails["approx_unit"].'</td>
                    <td>'.$invoicedetails["invoice_work_rate"].'</td><td>'.$invoicedetails["invoice_work_amount"].'</td></tr>';
                    $x++;    
                  }
                  #if ($invoice_details_totcount==$x-1) {
                  if ($invoice_details_count==$i+1) { 
                  $invoice_ex_amt = $invoice_data["invoice_basic_amt"]*$invoice_data["invoice_ex_rate"];
                          if (empty($invoice_data["invoice_tax_amt"])) { $invoice_tax_amt = ''; } else { $invoice_tax_amt = $invoice_data["invoice_tax_amt"]; }  
                    $pdf4 .=  '<tr><td></td><td align="left"><b>Basic Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].'):</b></td><td></td><td></td><td><b>'.$invoice_data["invoice_basic_amt"].'</b></td></tr>';
                ...
                if ($cargo_discount_flag==0) { 
                  ...
                  $invoice_ex_amt = $invoice_data["invoice_basic_amt"]*$invoice_data["invoice_ex_rate"];
                    ...
                    $pdf4 .=  '<tr><td></td><td align="left"><b>Basic Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].'):</b></td><td></td><td></td><td></td><td><b>'.$invoice_data["invoice_basic_amt"].'</b></td></tr>';
                    if (!empty($invoice_data["invoice_discount"])) {
                          $pdf4 .=  '<tr><td></td><td align="left"><b>Discount Amount (Discount '.$invoice_data["invoice_discount"].'%):</b></td><td></td><td></td><td></td><td><b>'.sprintf('%.2f', $invoice_data["invoice_discount_amt"]).'</b></td></tr>';
                    }
                    if (!empty($invoice_tax_amt)) {
                          $pdf4 .=  '<tr><td></td><td align="left"><b>Tax Amount (VAT '.$invoice_data["invoice_vat_percent"].'%) :</b></td><td></td><td></td><td></td><td><b>'.$invoice_tax_amt.'</b></td></tr>';
                    }
                    $pdf4 .=  '<tr><td></td><td align="left"><b>Total Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].'):</b></td><td></td><td></td><td></td><td><b>'.sprintf('%.2f', $invoice_data["invoice_amt"]).'</b></td></tr>';
                    $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5" align="center">';
                          $pdf4 .=  '<tr><td width="100.7%"><b>Amount : - </b> '.$invoice_data["currency"].' '.strtoupper($this->numtowords(sprintf('%.2f', $invoice_data["invoice_amt"]),$invoice_data["subunit"])).'</td></tr>';
                          $pdf4 .=  '</table>'; 
                    } /*** else {
                    if ($i==1) { 
                      $invoice_ex_amt = $invoice_data["invoice_basic_amt"]*$invoice_data["invoice_ex_rate"];
            ...
            if (count($cargo_group_arr)>1) { 
              if ($cargo_discount_flag==0) { 
                $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5" align="center">';
                $pdf4 .=  '<tr><td width="7%"><b>Sr.No.</b></td><td><b>Cargo Group</b></td><td width="47%"><b>Invoice Details</b></td><td width="10%"><b>Quantity</b></td><td width="10%"><b>Rate ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td><td width="10%"><b>Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td></tr>';
                ...
                $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5" align="center">';
                $pdf4 .=  '<tr><td width="7%"><b>Sr.No.</b></td><td width="16%"><b>Cargo Group</b></td><td width="37%"><b>Invoice Details</b></td><td width="10%"><b>Quantity</b></td><td width="10%"><b>Rate ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td><td width="10%"><b>Discount (%)</b></td><td width="10%"><b>Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td></tr>';
                foreach($invoice_details as $invoicedetails){
                  if ($invoicedetails["approx_unit"]=='NONE') { $invoicedetails["approx_unit"] = ''; }
                  if ($invoicedetails["invoice_work_rate"]==0) { $invoicedetails["invoice_work_rate"] = ''; }
                  $pdf4 .=  '<tr><td>'.$x.'</td><td align="left">'.$invoicedetails["cargo_group"].'</td><td align="left">'.htmlspecialchars($invoicedetails["work_type"]).'</td><td>'.$invoicedetails["approx_qty"].' '.$invoicedetails["approx_unit"].'</td>
                ...
                $invoice_ex_amt = $invoice_data["invoice_basic_amt"]*$invoice_data["invoice_ex_rate"];
                          if (empty($invoice_data["invoice_tax_amt"])) { $invoice_tax_amt = ''; } else { $invoice_tax_amt = $invoice_data["invoice_tax_amt"]; }  
                    $pdf4 .=  '<tr><td></td><td align="left"><b>Basic Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].'):</b></td><td></td><td></td><td></td><td></td><td><b>'.$invoice_data["invoice_basic_amt"].'</b></td></tr>';
                    if (!empty($invoice_data["invoice_discount"])) {
                          $pdf4 .=  '<tr><td></td><td align="left"><b>Discount Amount (Discount '.$invoice_data["invoice_discount"].'%):</b></td><td></td><td></td><td></td><td></td><td><b>'.sprintf('%.2f', $invoice_data["invoice_discount_amt"]).'</b></td></tr>';
                    }
                    if (!empty($invoice_tax_amt)) {
                          $pdf4 .=  '<tr><td></td><td align="left"><b>Tax Amount (VAT '.$invoice_data["invoice_vat_percent"].'%) :</b></td><td></td><td></td><td></td><td></td><td><b>'.$invoice_tax_amt.'</b></td></tr>';
                    }
                    $pdf4 .=  '<tr><td></td><td align="left"><b>Total Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].'):</b></td><td></td><td></td><td></td><td></td><td><b>'.sprintf('%.2f', $invoice_data["invoice_amt"]).'</b></td></tr>';
                    $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5" align="center">';
                          $pdf4 .=  '<tr><td width="100%"><b>Amount : - </b> '.$invoice_data["currency"].' '.strtoupper($this->numtowords(sprintf('%.2f', $invoice_data["invoice_amt"]),$invoice_data["subunit"])).'</td></tr>';
                          $pdf4 .=  '</table>';
                   } /*** else {
                    if ($i==1) { 
                      $invoice_ex_amt = $invoice_data["invoice_basic_amt"]*$invoice_data["invoice_ex_rate"];
              ...
              if ($cargo_discount_flag==0) { 
                ...
                $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5" align="center">';
                $pdf4 .=  '<tr><td width="7%"><b>Sr.No.</b></td><td width="31%"><b>Invoice Details</b></td><td><b>Quantity</b></td><td width="15%"><b>Rate ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td><td width="15%"><b>Discount (%)</b></td><td width="15%"><b>Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td></tr>';
                foreach($invoice_details as $invoicedetails){
                  if ($invoicedetails["approx_unit"]=='NONE') { $invoicedetails["approx_unit"] = ''; }
                  if ($invoicedetails["invoice_work_rate"]==0) { $invoicedetails["invoice_work_rate"] = ''; }
                  $pdf4 .=  '<tr><td>'.$x.'</td><td align="left">'.htmlspecialchars($invoicedetails["work_type"]).'</td><td>'.$invoicedetails["approx_qty"].' '.$invoicedetails["approx_unit"].'</td>
          ...
          $content .= '<br><br /><br />';
          //$content .= '<table border="0" cellspacing="0" cellpadding="2" align="center">';
          //$content .= '<tr><td><b><u>Payment Terms : Within 30 Days Upon Receipt Of Invoice</u></b></td></tr>';
          //$content .= '</table>';
    ...
    public function index_prev0502()
    {
        ...
        $file_name = 'Invoice_'.$result[0]['invoice_no'].'.pdf';
          ...
          $x = 1;
          if ($invoice_details_count>1)  { 
            for($i=0;$i<=count($invoice_details_count);$i++) {
              if ($i>0) {
              $pdf4 .= '<br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>';
              $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5">';
              if (!empty($invoice_data['file_no'])) { $pdf4 .= '<tr><th width="20%"><b>Job No</b></th><th width="80%">'.$invoice_data['file_no'].'</th></tr>'; }
              ...
              if (count($cargo_group_arr)>1) { 
                ...
                if ($cargo_discount_flag==0) {
                  ...
                  $invoice_ex_amt = $invoice_data["invoice_basic_amt"]*$invoice_data["invoice_ex_rate"];
                    ...
                    $pdf4 .=  '<tr><td></td><td align="left"><b>Total Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].'):</b></td><td></td><td></td><td></td><td><b>'.sprintf('%.2f', $invoice_data["invoice_amt"]).'</b></td></tr>';
                    $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5" align="center">';
                          $pdf4 .=  '<tr><td width="100.7%"><b>Amount : - </b> '.$invoice_data["currency"].' '.strtoupper($this->numtowords($invoice_data["invoice_amt"],$invoice_data["subunit"])).'</td></tr>';
                          $pdf4 .=  '</table>'; 
                    }     
                  $pdf4 .= '</table>';  
                }
            ...
            if (count($cargo_group_arr)>1) { 
              if ($cargo_discount_flag==0) { 
                ...
                $invoice_ex_amt = $invoice_data["invoice_basic_amt"]*$invoice_data["invoice_ex_rate"];
                    ...
                    $pdf4 .=  '<tr><td></td><td align="left"><b>Total Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].'):</b></td><td></td><td></td><td></td><td></td><td><b>'.sprintf('%.2f', $invoice_data["invoice_amt"]).'</b></td></tr>';
                    $pdf4 .= '<table border="1" cellspacing="0" cellpadding="5" align="center">';
                          $pdf4 .=  '<tr><td width="100%"><b>Amount : - </b> '.$invoice_data["currency"].' '.strtoupper($this->numtowords($invoice_data["invoice_amt"],$invoice_data["subunit"])).'</td></tr>';
                          $pdf4 .=  '</table>';
                   }         
                $pdf4 .= '</table>';
    ...
    public function numtowords($number,$subunit){ 
          ...
          $result = implode('', $str);
          $reminder = fmod($point,10); // Shivaji made chanes instead of $point % 10
          /*$points = ($point) ?
            "." . $words[$point / 10] . " " . 
