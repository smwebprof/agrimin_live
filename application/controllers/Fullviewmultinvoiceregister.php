...
class Fullviewmultinvoiceregister extends CI_Controller {
    ...
    public function index()
    {
        ...
        $this->data['title']='ACI - Fullviewmultinvoiceregister';    
        $this->data['layout_body']='fullviewmultinvoiceregister';
