...
class Delcargomaster extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['layout_body']='delcargomaster';

		$result = $this->Cargo_master->delcargomaster($id);

		########################### Log Activity ######################################
            $this->load->model('Activity_master');
            $params['module'] = 'delcargomaster';
            $params['date_time'] = $dt;
        ...
        ##################################################################
 		...
 		$viewinteractions = BASE_PATH."viewcargomaster";
