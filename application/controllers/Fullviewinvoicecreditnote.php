...
class Fullviewinvoicecreditnote extends CI_Controller {
    ...
    public function index()
    {
        ...
        $result = $this->Credit_master->getCreditdataById($id);
        //print_r($result);exit;
        $invoice_details = $this->Credit_master->getCreditdetailsById($id);
        ...
        $this->data['title']='ACI - Fullviewinvoicecreditnote';    
        $this->data['layout_body']='fullviewinvoicecreditnote';
