...
class Editspecificationmaster extends CI_Controller {
	...
	public function index()
	{
        ...
        if (@$_POST) {
        	...
        	$resultdata = $this->Lab_master->updatelabspecifications($_POST);
        	...
        	#print_r($branchs);exit;
   			...
   			$this->data['title'] = 'ACI - Editspecificationmaster';
			#$this -> load -> model('campaign_model');
			
			$this->data['layout_body']='editspecificationmaster';
