...
class Addfileregisterinsp extends CI_Controller {
	...
	public function index()
	{
        ...
        if ($_POST) {
        	...
        	/*if (empty($_POST['cargo'][0])) { 
        		$redirect_url = BASE_PATH."Addfileregister?msg=2";
                redirect($redirect_url);	
        	}*/ 
        	...
        	if ($resultdata) {
        		...
        		$email_vessel = $file_details[0]['warehouse'];
				...
				$file_email_report .= '<table width="100%" cellpadding="0" border="1">
		          		 <tr><td align="center"><b>FILE NO</b></td><td align="center"><b>CREATED ON</b></td><td align="center"><b>CREATED BY</b></td><td align="center"><b>CLIENT NAME</b></td><td align="center"><b>WAREHOUSE</b></td><td align="center"><b>TYPE OF JOB</b></td></tr>
		        ...
		        #$this->email->cc($email_cc);
		        $this->email->bcc('shivaji.dalvi@rcaindia.com,prashant.joshi@rcaindia.net,namrata@rcaindia.net,shivdalvi@gmail.com');
	...
	///////////////////////////////////////////////////////////////////////////////
			$this->data['layout_body']='addfileregisterinsp';
