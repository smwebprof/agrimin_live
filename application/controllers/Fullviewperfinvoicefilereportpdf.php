...
class Fullviewperfinvoicefilereportpdf extends CI_Controller {
    ...
    public function index()
    {
        ...
        $pdf1 = '<table width="100%" cellpadding="0" border="0">
          <tr>
              ...
              <td width="50%">
                  <table width="100%" border="0" align="left">
                      ...
                      <tr><td>'.$invoice_data['client_address'].'</td></tr>
                      <tr><td>'.$invoice_data['client_city'].','.$invoice_data['client_state'].','.$invoice_data['client_country'].'</td></tr>';
              ...
              if (!empty(@$ttel)) { $pdf1 .= '<tr><td>Phone : '.@$ccode.' '.@$ttel.'</td></tr>'; }         
                  ...
                  $pdf1 .= '<tr><td></td></tr><tr><td><b>Kind Attention : '.@$invoice_data['kind_attention'].'</b></td></tr>
                  </table>    
              </td>';
           /*$pdf .= '<td width="50%">
          ...
          $pdf4 .=  '<tr><td width="50%"><b>Work Item</b></td><td width="15%"><b>Quantity</b></td><td width="15%"><b>Rate ('.$currencyid.'/ P'.$approx_unit.')</b></td><td width="20%"><b>Amount (In '.$currencyid.')</b></td></tr>';
        ...
        foreach($rows as $invoice_data){
          ...
          <tr>
              ...
              if (!empty(@$ttel)) { $pdf .= '<tr><td>Phone : '.@$ccode.' '.@$ttel.'</td></tr>'; }         
                  ...
                  $pdf .= '<tr><td></td></tr><tr><td><b>Kind Attention : '.@$invoice_data['kind_attention'].'</b></td></tr>
                  </table>    
              </td>';
           /*$pdf .= '<td width="50%">
                  <table width="100%" border="0" align="right">
