...
class Viewfileregistermult extends CI_Controller {
	...
	public function index()
	{
		...
		if (@$_POST['submit']=='excel') {
			$redirecturl = BASE_PATH."Viewexcelfileregistermult?file_from_date=".@$_POST['file_from_date']."&file_To_date=".@$_POST['file_To_date']."&file_no_type=".@$_POST['file_no_type']."&status=".@$_POST['status']."&clients_name=".@$_POST['clients_name']."&file_nos=".@$_POST['file_nos'];
		...
		if (@$_POST['viewfileregister']) {
			...
			$result = $this->File_master->getAllFiledataMult();
			//print_r($result);exit;
			$clients = $this->Client_master->getClientdataByBranchid($_SESSION['branch_id']);
