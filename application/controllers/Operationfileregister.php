	...
	public function index()
	{
        ...
        if ($_POST) {
			...
			$this->data['layout_body']='operationfileregister';
	 	    $this->data['file_status']=$getFileStatus; 
            ...
            //print_r($getFileStatus);exit;

        	$doc_types_id = $this->Document_master->getDocumentDetailsById($id);

            $cargo_details = $this->File_master->editFileCargoDetailsById($id);

            $mail_doc_details = $this->Document_master->getMailDocumentDetailsById($id);
			...
			$this->data['doc_types_info'] = @$doc_types_id;
            $this->data['cargo_details']=$cargo_details;
            $this->data['mail_doc_details']=@$mail_doc_details;
			$this->data['layout_body']='operationfileregister';
            $this->data['file_status']=$getFileStatus;
