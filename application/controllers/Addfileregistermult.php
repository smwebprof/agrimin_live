...
class Addfileregistermult extends CI_Controller {
	...
	public function index()
	{
        ...
        if ($_POST) {
            ...
            $addFileCargoDetails = $this->File_master->addFileCargoDetailsMult($this->input->post());
	...
	///////////////////////////////////////////////////////////////////////////////
			$this->data['layout_body']='addfileregistermult';
			...
			$this->data['createinvoice']=$createinvoice;
	 		$this->load->view('admin/layout/main_app_file_mult', $this->data);
