...
class Viewfilereport extends CI_Controller {
	...
	public function index()
	{
		...
		$this->data['title'] = 'ACI - viewfilereport';
		#$this -> load -> model('campaign_model');
		
		$this->data['layout_body']='viewfilereport';

		$result = $this->Report_master->getAllFiledata($status);
		//print_r($result);exit;
