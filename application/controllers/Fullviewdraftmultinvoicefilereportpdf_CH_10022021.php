        ...
        $file_name = 'Invoice_'.$result[0]['invoice_no'].'.pdf';
          ...
          if (count($cargo_group_arr)>1) { 
            if ($cargo_discount_flag==0) { 
              $pdf4 .=  '<tr><td><b>Cargo Group</b></td><td width="38%"><b>Invoice Details</b></td><td width="11%"><b>Quantity</b></td><td width="11%"><b>Rate ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td><td width="20%"><b>Amount ('.$invoice_data["sortname"].' '.$invoice_data["symbol"].')</b></td></tr>';
            } else { 
