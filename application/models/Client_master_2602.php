...
class Client_master extends CI_Model{ 
    ...
    function getClientdata(){  //$id
     ...
     function getClientdataByBranchid($params){
        ...
        $querystring = "SELECT id,client_name,address,city_id,state_id,country_id FROM agrimin_client_master where (client_type = 'Client' or client_type is null) and branch_id =".$params." and is_active = 1 order by client_name";
