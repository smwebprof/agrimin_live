...
class Company_master extends CI_Model{ 
    ...
    function fetch_op_year($comp_id)
    {
      ...
      $querystring = "SELECT * FROM agrimin_operation_year WHERE comp_id = '".$comp_id."' and is_active = 1 order by id asc";
      $queryforpubid = $this->db->query($querystring);
   ...
   function fetchCountryById($params){ 
    ...
    function get_op_year($comp_id)
    {
      ...
      $querystring = "SELECT * FROM agrimin_operation_year WHERE comp_id = '".$comp_id."' and is_active = 1 order by id";
      $queryforpubid = $this->db->query($querystring);
