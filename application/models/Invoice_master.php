...
class Invoice_master extends CI_Model{ 
    ...
    function getAllInvoicedata(){  //$params
        ...
        //$querystring =  "SELECT aim.*,aft.file_no,aft.id file_id,ac.currency FROM agrimin_invoice_master aim left join agrimin_fileregister_transaction aft on aft.id=aim.file_no left join agrimin_countries ac on aim.invoice_currency=ac.id WHERE aim.user_comp_id =  '".$_SESSION['comp_id']."' and aim.user_branch_id = '".$_SESSION['branch_id']."' and aim.is_active = 1 and aim.invoice_info = '".$params."' Order by aim.id desc";
    ...
    function getInvoiceByFinalStatus(){ 
        ...
        $querystring =  "SELECT aim.id,aim.invoice_no FROM agrimin_invoice_master aim WHERE aim.user_comp_id =  '".$_SESSION['comp_id']."' and aim.user_branch_id = '".$_SESSION['branch_id']."' and aim.is_active = 1 and aim.invoice_type = 'Final'";
    ...
    function getInvoiceDetailsByFileNo($params,$inv_no){ 
        ...
        #$querystring =  "SELECT aid.* FROM agrimin_invoice_master aim left join agrimin_invoice_details aid on aim.id=aid.invoice_no WHERE aim.file_no =  '".$params."' and aim.id =  '".$inv_no."' and aim.invoice_type = 'Final'";
        $querystring =  "SELECT aid.file_cargo_id,sum(aid.approx_qty) approx_qty FROM agrimin_invoice_master aim left join agrimin_invoice_details aid on aim.id=aid.invoice_no WHERE aim.file_no =  '".$params."' and aim.invoice_type = 'Final'  and aid.cargo_group != 'Other' group by aid.file_cargo_id";
    ...
    function getInvoiceTotalQuantByFileNo($params){ 
        ...
        $querystring =  "SELECT aid.file_cargo_id,sum(aid.approx_qty) approx_qty FROM agrimin_invoice_details aid,agrimin_invoice_master aim Where aim.file_no = '".$params."' and aim.id = aid.invoice_no and aim.invoice_type = 'Final'  and aid.cargo_group != 'Other' GROUP BY aid.file_cargo_id";
    ...
    function getMultInvoiceIdByFileNo($params){ 
        ...
        $querystring =  "SELECT aim.* FROM agrimin_invoice_master aim WHERE aim.file_no =  '".$params."' and aim.invoice_id !=  '' order by id desc limit 1";
    ...
    function getMultInvoiceByFileNo($params){ 
        ...
        $querystring =  "SELECT aim.* FROM agrimin_invoice_master aim WHERE aim.file_no =  '".$params."' order by id desc limit 1";
    ...
    function getAllInvoicedataSearch($data){  //$id
      ...
      if ($data['file_no_type']) {
       ...
       #$querystring =  "SELECT aim.*,aft.file_no,aft.id file_id,ac.currency FROM agrimin_invoice_master aim left join agrimin_fileregister_transaction aft on aft.id=aim.file_no left join agrimin_countries ac on aim.invoice_currency=ac.id WHERE aim.user_comp_id =  '".$_SESSION['comp_id']."' and aim.user_branch_id = '".$_SESSION['branch_id']."' and aim.is_active = 1 and aim.invoice_info = '".$data['invoice_info']."' $search Order by aim.id desc";

       $querystring =  "SELECT aim.*,aft.file_no,aft.id file_id,ac.currency FROM agrimin_invoice_master aim left join agrimin_fileregister_transaction aft on aft.id=aim.file_no left join agrimin_countries ac on aim.invoice_currency=ac.id WHERE aim.user_comp_id =  '".$_SESSION['comp_id']."' and aim.user_branch_id = '".$_SESSION['branch_id']."'  $search Order by aim.id desc";
       //and aim.is_active = 1
    ...
    function getInvoiceIdByBranch() { 
        ...
        $querystring = 'SELECT invoice_id,invoice_no FROM agrimin_invoice_master aim Where aim.user_comp_id = "'.$_SESSION['comp_id'].'" and aim.user_branch_id = "'.$_SESSION['branch_id'].'" and aim.op_year = "'.$_SESSION['operatingyear'].'" Order By invoice_id desc limit 1';
    ...
    function getMultInvoiceIdByBranch() { 
        ...
        $querystring = 'SELECT invoice_id,invoice_no FROM agrimin_invoice_master aim Where aim.user_comp_id = "'.$_SESSION['comp_id'].'" and aim.user_branch_id = "'.$_SESSION['branch_id'].'" and aim.op_year = "'.$_SESSION['operatingyear'].'" Order By id desc limit 1';
    ...
    function getInvoiceIdMultiByBranch($invoice_id) { 
        ...
        $querystring = 'SELECT invoice_id,invoice_no FROM agrimin_invoice_master aim Where aim.user_comp_id = "'.$_SESSION['comp_id'].'" and aim.user_branch_id = "'.$_SESSION['branch_id'].'" and aim.op_year = "'.$_SESSION['operatingyear'].'" and aim.invoice_id = "'.$invoice_id.'" Order By id desc limit 1';
    ...
    function getInvoiceIdMultiCurrBal($invoice_id) { 
        ...
        $querystring = 'SELECT invoice_id,invoice_no,invoice_curr_bal FROM agrimin_invoice_master aim Where aim.user_comp_id = "'.$_SESSION['comp_id'].'" and aim.user_branch_id = "'.$_SESSION['branch_id'].'" and aim.op_year = "'.$_SESSION['operatingyear'].'" and aim.id = "'.$invoice_id.'" Order By id desc limit 1';
   ...
   function getCurrency(){  //$id
    ...
    public function deldraftinvoice($params){
        ...
        // Delete from agrimin_invoice_master
        $querystring = "DELETE FROM agrimin_invoice_master where id = '".$params."'";
        $queryforpubid = $this->db->query($querystring);

        // Delete from agrimin_invoice_details
        $querystring2 = "DELETE FROM agrimin_invoice_details where invoice_no = '".$params."'";
