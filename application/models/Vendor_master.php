...
class Vendor_master extends CI_Model{ 
    function __construct() { 
        // Set table name 
        $this->table = 'agrimin_vendor_master'; 
    } 
    ...
    //print_r($result);exit;
    $this->db->insert('agrimin_vendor_master',$result);
    ...
    function getVendortype(){ 
        ...
        $querystring = "SELECT * FROM agrimin_vendor_type Where is_active = 1 order by id asc";
    ...
    function getAllVendordata(){ 
        ...
        $querystring = "SELECT avm.*,avt.vendor_type vendor_info,acnt.name country,ast.name state,act.name city FROM agrimin_vendor_master avm left join agrimin_countries acnt ON acnt.id=avm.country_id left join agrimin_states ast ON ast.id=avm.state_id left join agrimin_cities act ON act.id=avm.city_id left join agrimin_vendor_type avt ON avt.id=avm.vendor_type Where avm.is_active = 1 and avm.user_comp_id = '".$_SESSION['comp_id']."' and avm.user_branch_id = '".$_SESSION['branch_id']."'";
    ...
    function getVendorById($params){  //$id
        ...
        $querystring = "SELECT * FROM agrimin_vendor_master Where id =".$params." order by id";
        $queryforpubid = $this->db->query($querystring);
    ...
    function getVendorByName($params){  //$id
        ...
        $querystring = "SELECT * FROM agrimin_vendor_master Where   vendor_name = '".$params."' order by id";
        $queryforpubid = $this->db->query($querystring);
    ...
    public function updateVendorData($data)
      ...
      $this->db->limit(1);
      $this->db->update('agrimin_vendor_master',$result);
   ...
   function getAccountledgerById($params){  //$id
    ...
    function getAccountledgerByIdType($id,$t){  //$id
        ...
        $querystring = "SELECT * FROM agrimin_account_ledger Where vendor_name =".$id." and ledger_type = '".$t."' order by id desc limit 1";
        $queryforpubid = $this->db->query($querystring);
    ...
    function getAccountledgerByIdLast($params){  //$id
        ...
        $querystring = "SELECT * FROM agrimin_account_ledger Where vendor_name =".$params." order by id desc limit 1";
        $queryforpubid = $this->db->query($querystring);
    ...
    function getAccountledgerByCreditLast($params){  //$id
        ...
        $querystring = "SELECT * FROM agrimin_account_ledger Where vendor_name =".$params." and ledger_type = 'Credit' order by id desc limit 1";
        $queryforpubid = $this->db->query($querystring);
    ...
    function getAccountledgerByCredit($params){  //$id
        ...
        $querystring = "SELECT * FROM agrimin_account_ledger Where vendor_name =".$params." and ledger_type = 'Credit' order by id";
        $queryforpubid = $this->db->query($querystring);
    ...
    function getAccountledgerByDebit($params){  //$id
        ...
        $querystring = "SELECT * FROM agrimin_account_ledger Where vendor_name =".$params." and ledger_type = 'Debit' order by id";
        $queryforpubid = $this->db->query($querystring);
    ...
    function getAccountledgerByClosingBal($params){  //$id
        ...
        $querystring = "SELECT * FROM agrimin_account_ledger Where vendor_name =".$params." and ledger_type = 'Closing Balance' order by id";
        $queryforpubid = $this->db->query($querystring);
   ...
   function getAllAccountledger($data){ 
    ...
    function getAllAccountledgerSearch($data){ 
        ...
        $querystring = "SELECT aal.*,avm.id vendor_id,avm.vendor_name vendor FROM agrimin_account_ledger aal left join agrimin_vendor_master avm ON aal.vendor_name=avm.id Where aal.is_active = 1 $search Order by aal.id desc"; //aal.id
        //echo $querystring;exit;
        $queryforpubid = $this->db->query($querystring);
    ...
    public function delaccountledger($id)
      ...
      $this->db->where('id', $id);
      $this->db->limit(1);
      $this->db->update('agrimin_account_ledger',$result);
    ...
    public function delledgerclosingbl($id)
      ...
      $querystring = "DELETE FROM agrimin_account_ledger where id = '".$id."'";
      $queryforpubid = $this->db->query($querystring);
    ...
    function getAllledgerreport(){ 
        ...
        $querystring = "SELECT avm.vendor_name, sum(aal.credit_amount) totalCredit, sum(aal.debit_amount) totaldebit, (sum(aal.credit_amount) - sum(aal.debit_amount)) BalanceAmount FROM agrimin_account_ledger aal left join agrimin_vendor_master avm on aal.vendor_name = avm.id GROUP BY vendor_name";
    ...
    function getAllledgerreportSearch($data){ 
        ...
        //$querystring = "SELECT avm.vendor_name, sum(aal.credit_amount) totalCredit, sum(aal.debit_amount) totaldebit, (sum(aal.credit_amount) - sum(aal.debit_amount)) BalanceAmount FROM agrimin_account_ledger aal left join agrimin_vendor_master avm on aal.vendor_name = avm.id $search GROUP BY vendor_name";

        $querystring = "SELECT aal.*,avm.id vendor_id,avm.vendor_name FROM agrimin_account_ledger aal left join agrimin_vendor_master avm ON aal.vendor_name=avm.id Where aal.is_active = 1  $search Order by aal.id";
    ...
    function getAllledgerreportCount(){
        $querystring = "SELECT vendor_name,count(vendor_name) count from agrimin_account_ledger GROUP BY vendor_name";
