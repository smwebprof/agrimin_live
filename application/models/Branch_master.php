...
class Branch_master extends CI_Model{ 
    ...
    #print_r($result);exit;
    $this->db->insert('agrimin_branch_master',$result);
    ...
    function getBranchdata(){ 
        ...
        $querystring = "SELECT id,branch_name,branch_email,address,bank_name,bank_branch_name FROM agrimin_branch_master order by id desc";
    ...
    function getBranchdataByStatus(){ 
        ...
        $querystring = "SELECT id,branch_name,branch_email,address,bank_name,bank_branch_name FROM agrimin_branch_master where is_active = 1 order by id desc";
        $queryforpubid = $this->db->query($querystring);
    ...
    function getBranchdataById($params){ 
        ...
        #$querystring = "SELECT id,branch_name,branch_email,address,bank_name,bank_branch_name FROM agrimin_branch_master WHERE id = '".$params."'";

        $querystring = "SELECT abm.*,ac.sortname,ac.currency FROM agrimin_branch_master abm left join agrimin_countries ac ON abm.countryid=ac.id WHERE abm.id = '".$params."'";
    ...
    function getBranchById($params){ 
        ...
        $querystring = "SELECT * FROM agrimin_branch_master WHERE id = '".$params."'";
        $queryforpubid = $this->db->query($querystring);
    ...
    function getBranchByCompanyId($params){ 
        ...
        $querystring = "SELECT * FROM agrimin_branch_master WHERE comp_id = '".$params."'";
        $queryforpubid = $this->db->query($querystring);
     ...
     function getBranchInvoicesdata(){ 
        ...
        $querystring = "SELECT * FROM agrimin_branch_master WHERE create_invoice = '1'";
        $queryforpubid = $this->db->query($querystring);
    ...
    public function updateBranchData($data)
      ...
      $this->db->limit(1);
      $this->db->update('agrimin_branch_master',$result);
    ...
    public function delbranchmaster($id)
      ...
      $querystring = "DELETE FROM agrimin_branch_master where id = $id";
      $queryforpubid = $this->db->query($querystring);
