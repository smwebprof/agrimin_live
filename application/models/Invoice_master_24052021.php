...
class Invoice_master extends CI_Model{ 
    ...
    function getInvoiceDetailsByFileNo($params,$inv_no){ 
        ...
        $querystring =  "SELECT aid.file_cargo_id,sum(aid.approx_qty) approx_qty FROM agrimin_invoice_master aim left join agrimin_invoice_details aid on aim.id=aid.invoice_no WHERE aim.file_no =  '".$params."' and aim.invoice_type = 'Final' group by aid.file_cargo_id";
    ...
    function getInvoiceTotalQuantByFileNo($params){ 
        ...
        $querystring =  "SELECT aid.file_cargo_id,sum(aid.approx_qty) approx_qty FROM agrimin_invoice_details aid,agrimin_invoice_master aim Where aim.file_no = '".$params."' and aim.id = aid.invoice_no and aim.invoice_type = 'Final' GROUP BY aid.file_cargo_id";
