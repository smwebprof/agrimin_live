...
class PdfCreditenote extends TCPDF
{
    ...
    public function Header() {
        ...
        $CI->load->model('Credit_master');

        $id = base64_decode($_GET['id']);

        $result = $CI->Credit_master->getCreditFileInvoicedata($id);
        //print_r($result);exit;
    ...
    public function Footer() {
       ...
       //print_r($branch_details);exit;
        ...
        $this->writeHTML("_____________________________________________________________________________________________________________________________________________", true, false, false, false, '');
        $this->Ln(2);
